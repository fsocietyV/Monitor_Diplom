...
|-----------------------------------|------------------------------------------------|-----------------------------------------------------------------------------|----------------------------------------------------------|
| **СПИД-центр**                    | Обеспечение безопасности приложений.          | - Соблюдение требований 17-го приказа ФСТЭК. <br> - Эффективный мониторинг. | Использует SecureApp Monitor для мониторинга безопасности.|
